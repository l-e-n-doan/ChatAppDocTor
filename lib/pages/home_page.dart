        ...
        children: [
          GestureDetector(
            onTap: () {
              //popUpDialog(context);
              nextScreen(context, const SearchPage());
              //buttom in the center app when not anys chats
          ...
          const Text(
            "You've not joined any chats, tap on the add icon to create a chat with your favorite doctor or also search from top search button.",
            textAlign: TextAlign.center,
          )
        ],
      ),
